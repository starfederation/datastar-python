"""Integration test: datastar_response within a live Litestar app."""
...
@pytest.mark.anyio
async def test_litestar_handlers_cover_matrix() -> None:
    """Ensure Litestar handlers across sync/async and gen/value work end-to-end."""
    ...
    app = Litestar(route_handlers=[sync_value, sync_gen, async_value, async_gen, ping])
